...
if (!isset($_GET['id'])) {
    header("Location: consulta-ce.php");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        try {
            $stmt = $pdo->prepare("
                UPDATE asignaturas 
                SET nombre = ?, grupo = ?, profesor = ?, cupo_maximo = ?, descripcion = ?
                WHERE id = ?
            ");
            
            if ($stmt->execute([$nombre, $grupo, $profesor, $cupo_maximo, $descripcion, $id])) {
                header("Location: consulta-ce.php?msg=actualizado");
                exit;
            } else {
                $errores[] = 'Error al actualizar la asignatura';
            }
...
<head>
    ...
    <title>Editar Asignatura - Instituto Padres de la Patria</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted">Modifica los datos de la asignatura</p>
                </div>
                    ...
                    <div class="card-body p-4">
                        <form method="POST" action="">
                            ...
                            <div class="alert alert-info">
                                ...
                                <strong>ID de la asignatura:</strong> <?php echo $id; ?>
                            </div>
                            ...
                            <div class="mt-4 d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-warning">
                                    <i class="fas fa-save me-1"></i>Actualizar Asignatura
                                </button>
                            </div>
